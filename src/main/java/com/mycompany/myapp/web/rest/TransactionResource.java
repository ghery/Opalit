...
public class TransactionResource {
     ...
     * @return
     */
    @GetMapping("/positions/{idPosition}")
    @Timed
    public ResponseEntity<Transaction> getPosition(@PathVariable Long idPosition) {
        log.debug("REST request to get Transaction : {}", idPosition);
        Transaction position = transactionRepository.findOne(idPosition);
